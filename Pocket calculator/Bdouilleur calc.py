...
class Calculate(Tk):
    def __init__(self):
        ...
        self.can_button = Canvas(self, width=500, height=200, bg='black', bd=0, highlightthickness=0)
    ...
    def create_button(self):
        self.button_zero = Button(self.can_button, text='0', font=('Impossible', 30), bg='#179A04', fg='black', padx=15,
                                  command=self.zero_button, width=2)
        self.button_one = Button(self.can_button, text='1', font=('Impossible', 30), bg='#179A04', fg='black', padx=15,
                                 command=self.one_button, width=2)
        self.button_two = Button(self.can_button, text='2', font=('Impossible', 30), bg='#179A04', fg='black', padx=15,
                                 command=self.two_button, width=2)
        self.button_tree = Button(self.can_button, text='3', font=('Impossible', 30), bg='#179A04', fg='black', padx=15,
                                  command=self.three_button, width=2)
        self.button_four = Button(self.can_button, text='4', font=('Impossible', 30), bg='#179A04', fg='black', padx=15,
                                  command=self.four_button, width=2)
        self.button_five = Button(self.can_button, text='5', font=('Impossible', 30), bg='#179A04', fg='black', padx=15,
                                  command=self.five_button, width=2)
        self.button_six = Button(self.can_button, text='6', font=('Impossible', 30), bg='#179A04', fg='black', padx=15,
                                 command=self.six_button, width=2)
        self.button_seven = Button(self.can_button, text='7', font=('Impossible', 30), bg='#179A04', fg='black',
                                   padx=15,
                                   command=self.seven_button, width=2)
        self.button_eight = Button(self.can_button, text='8', font=('Impossible', 30), bg='#179A04', fg='black',
                                   padx=15,
                                   command=self.eight_button, width=2)
        self.button_nine = Button(self.can_button, text='9', font=('Impossible', 30), bg='#179A04', fg='black', padx=15,
                                  command=self.nine_button, width=2)
        self.button_plus = Button(self.can_button, text='+', font=('Impossible', 30), bg='green', fg='black', padx=15,
                                  command=self.plus_button, width=2)
        self.button_moins = Button(self.can_button, text='-', font=('Impossible', 30), bg='green', fg='black',
        ...
        self.button_clear = Button(self.can_button, text='C', font=('Impossible', 30), bg='green', fg='black', padx=15,
